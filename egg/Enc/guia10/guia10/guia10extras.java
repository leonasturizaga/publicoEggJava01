...
// totales.
//En el programa principal, crear una lista de tipo "EquipoDe…" y agregar 10 objetos de tipo equipo a la lista. Luego,
// mostrar por pantalla de forma ordenada según cantidad de puntos los nombres de cada equipo, su cantidad de puntos,
...
//4) Eres el responsable de una tienda de libros y necesitas gestionar el inventario de tu tienda. Debes desarrollar un
// programa en Java que te permita realizar las siguientes operaciones:
...
//5) Crear la clase “Tarea” con los siguientes atributos: título, descripción, estado (boolean) y fecha de creación. Agregar
// constructor vacío, con parámetros, getters, setters y demás necesario.
//Dentro del servicio vamos a crear un objeto de tipo Tarea pidiéndole los datos al usuario.Por defecto, al crear una tarea
// se tiene que asignar el valor de true al atributo estado, esto indicará que la tarea está en proceso.
...
//- Modificar el estado de la tarea a false, de esta forma se considera terminada. El usuario debe ingresar el nombre de la
// tarea a modificar.
//- Remover una tarea. El usuario debe ingresar el nombre de la tarea a remover.


//6) Crear la clase "Pedido" con los siguientes atributos:  número de orden, descripción y fecha de creación. Agregar
// constructor vacío, con parámetros, getters, setters y demás necesario.
//Dentro del servicio vamos a crear un método para la creación del objeto Pedido, solicitando los datos al usuario. Dichos
// objetos creados, los vamos a guardar dentro de una lista de Pedidos.
//Luego debemos:
//- Buscar un pedido según el número de orden y mostrarlo.
//- Buscar un pedido según una fecha ingresada por el usuario y mostrarlo. En el caso de que no existan pedidos con esa
// fecha, debe informar al usuario.
...
//Crea un sistema de gestión de empleados en Java. Este sistema debe ser capaz de agregar, eliminar, buscar y actualizar
// empleados. Cada empleado debe tener un nombre, una edad, un número de identificación único y una fecha de contratación.
